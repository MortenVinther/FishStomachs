...
```
FishStomachs provide functions for estimating the mean and variance of the contents from bootstrapping. 
...
The table below show each "haul" include a number of stomachs from various predator sizes.
...
The result of the call, bd, is a list wit STOMobs object.
