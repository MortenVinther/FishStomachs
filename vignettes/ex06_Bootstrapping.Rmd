...
bb<-bootsMean(b=bt4,min_prey=0.01,source=source,by_prey_size=FALSE)
head(bb)

plotboots(b=bt4,show_plot=TRUE,cut_pred_size=c(1,4),addTitle=TRUE,tAngle=90)


bb<-bootsMean(b=bt4,min_prey=0.01,source=source,by_prey_size=TRUE)
plotboots(b=bt4,show_plot=TRUE,cut_pred_size=c(1,4),addTitle=TRUE,tAngle=90)
...
bb<-bootsMean(b=bt4,min_prey=0.01,source=source,by_prey_size=FALSE,do_Diri=TRUE)
head(select(bb,prey_name, phi,param,mu,n_sample))
