...
```
The tables above shows that e.g. cod in quarter 1 has 42 "hauls" with stomach data for predator size 0100-0149. 
The table below show each "haul" include a number of stomachs from a vrious predator sizes.
...
The bootstrapping stata and id are added to the STOMobs data by a call to bootstrap_data().
