...
iii. Area level. ICES roundfish areas are used for area strata. Average diet within an area is calculated a as weighted mean, weighted by the predator survey cpue by the sub-area (ICES rectangle)
...
Now it just to call the estimate population diet function.
