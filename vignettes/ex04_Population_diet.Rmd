...
Plots can also be done where the prey size class is shown. In this plot data from all quarters in 1991 are combined (simple mean of all quarters of 1991).
...
plotSize(d2,cut_pred_size=c(1,3),addTitle=TRUE, byVar=c('year-quarter','year','quarter','none')[2])
