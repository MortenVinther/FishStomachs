...
This example shows the basic data structures and  how to read data on exchange data format. Further, examples are shown how to make initial editing and addition of data.
...
```
In this case we just want to keep the mandatory data fields (for illustrative purposes)  as specified by  the parameter keep_just_mandatory_fields. See the documentation for exchange format in the help for read_exchange_data().
